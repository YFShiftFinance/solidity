...
bool ASTJsonConverter::visit(SourceUnit const& _node)
{
	...
	if (_node.annotation().path.set())
		attributes.emplace_back("absolutePath", *_node.annotation().path);
...
bool ASTJsonConverter::visit(ImportDirective const& _node)
{
	...
	if (_node.annotation().absolutePath.set())
		attributes.emplace_back("absolutePath", *_node.annotation().absolutePath);
...
bool ASTJsonConverter::visit(StructDefinition const& _node)
{
	...
	if (_node.annotation().canonicalName.set())
